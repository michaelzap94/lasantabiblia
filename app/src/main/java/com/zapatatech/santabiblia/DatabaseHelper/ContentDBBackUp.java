...
class ContentDBBackUp extends SQLiteOpenHelper {
    private static final String TAG = "ContentDBBackUp";
    private static int DATABASE_VERSION = 1;
    private static String DB_NAME = "content.db";
    private Context context;
    private static ContentDBBackUp dbHelperSingleton = null;

    public static synchronized ContentDBBackUp getInstance(Context context) {
        ContentDBBackUp dbHelperInner;
        synchronized (ContentDBBackUp.class) {
            if (dbHelperSingleton == null) {
                //if not singleton, create one.
                dbHelperSingleton = new ContentDBBackUp(context);
            }//else return existing one.
            dbHelperInner = dbHelperSingleton;
        }
        return dbHelperInner;
    }
    public ContentDBBackUp(Context context) {
